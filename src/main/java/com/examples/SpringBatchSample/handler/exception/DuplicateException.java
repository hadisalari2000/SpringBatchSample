...
public class DuplicateException extends RuntimeException{
    ...
    private DuplicateException(String message, HttpStatus status) {
        super(message);
        this.status=status;
    }

    public static DuplicateException getInstance(Class clazz, String... paramsMap){
        ...
        String message=String.format(
                ...
                searchParams);
        return new DuplicateException(message, HttpStatus.BAD_REQUEST);
    }
